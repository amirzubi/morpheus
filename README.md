...
## Datenausgabe
Die Webapplikation sollte die aktuellen Kurse und den Totalwert der einzelnen Portfolioeinträge wiedergeben. Dabei wird folgendes gerechnet: Betrag Kryptowährung * Kurs Kryptowährung
Zusätzlich sollte der Gesamtwert des Portfolios ausgegeben werden. Dabei wird folgendes gerechnet: (Betrag Kryptowährung 1 * Kurs Kryptowährung 1) + (Betrag Kryptowährung 2 * Kurs Kryptowährung 2)... 
